...
const dictionaries = {
  ru: {
    ...
    ctaBanner: {
      ...
      titleAccent: "следующий продукт?",
      text: "Расскажите о своей идее — мы ответим в течение 24 часов с оценкой и планом.",
      cta: "Обсудить проект",
    },
    contact: {
  ...
  en: {
    ...
    ctaBanner: {
      ...
      text: "Tell us about your idea — we'll respond within 24 hours with an estimate and a plan.",
